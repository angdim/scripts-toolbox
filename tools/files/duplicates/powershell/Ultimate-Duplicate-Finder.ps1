...
# ============================================
# Пълен търсач на дубликати за Windows 11
...
# 3. Стартирай скрипта:
#     .\Ultimate-Duplicate-Finder.ps1 

Clear-Host
Write-Host "=== Пълен търсач на дубликати ==="
Write-Host ""
...
Write-Host ""
Write-Host "Искаш ли филтър по разширения? (пример: jpg, mp4, pdf)"
...
Write-Host ""
Write-Host "Искаш ли да изключиш папки? (пример: C:\Windows, D:\Temp)"
...
Write-Host " - $html"
Write-Host " - $log"
Write-Host " - $deleteList (само списък, не трие автоматично)"
